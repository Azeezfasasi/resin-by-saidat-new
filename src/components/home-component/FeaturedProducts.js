...
export default function FeaturedProducts() {
  ...
  useEffect(() => {
    const fetchFeaturedProducts = async () => {
      try {
        const response = await fetch('/api/product?type=featured&limit=6');
        const data = await response.json();
        
        // Get featured products
        const featuredProducts = data.products
          .filter(prod => prod.status === 'published' && !prod.isDeleted && prod.featured)
          .slice(0, 6);
      ...
      <section className="py-16 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12">
            ...
            <p className="text-gray-600 text-lg">Loading curated selections...</p>
          </div>
  ...
  return (
    <section className="py-16 px-4 bg-linear-to-b from-amber-50 via-white to-white">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="flex items-center justify-between mb-12">
          <div>
            ...
            <p className="text-gray-600 text-lg">
              Hand-picked resin creations curated just for you
            </p>
          </div>
          <Link
            href="/shop"
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative h-72 bg-gray-100 overflow-hidden">
                      ...
                      {/* Featured Badge */}
                      {product.featured && (
                        <div className="absolute bottom-4 left-4 bg-amber-600 text-white px-3 py-1 rounded-full text-xs font-semibold flex items-center gap-1">
